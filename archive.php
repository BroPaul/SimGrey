...
<div class="page archive">
	...
	<?php if(is_day()):?>您正在查看 <?php the_time('Y年m月d日');?> 的文章列表<?php endif;?>
	<?php if(is_month()):?>您正在查看 <?php the_time('Y年m月');?> 的文章列表<?php endif;?>
	<?php if(is_year()):?>您正在查看 <?php the_time('Y年');?> 的文章列表<?php endif;?>
...
<?php while(have_posts()):the_post();?>
	<div class="entry hentry">
		<div class="floatleft">
			...
			<h3 class="entry-title"><?php if(get_the_title()):?>
